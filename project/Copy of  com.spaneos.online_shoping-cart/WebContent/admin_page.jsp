...
<body background="shopping_home.jpg">
	...
	<div class="container">
						...
						<li class="dropdown"><a class="dropdown-toggle"
							...
							<ul class="dropdown-menu" name="catg">
								<c:forEach items="${catList}" var="cList">
									<li><a href="edit.Ado?catval=${cList.cat}"
										value="${cList.cat}">${cList.cat}</a> <a
										href="delete.Ado?catval=${cList.cat}"><span
											class="glyphicon glyphicon-trash"></span></a> <a
										href="edit.Ado?catval=${cList.cat}"><span
											class="glyphicon glyphicon-pencil"></span></a><a
										href="addProduct1.Ado?catval=${cList.cat}"><span
		...
		<div class="row">
			...
			<form action="adminPageInter.jsp" method="post" name="category">
				<!-- Modal -->
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<button type="submit" class="btn btn-primary" id="login">Add\r
									Products</button>
								<button type="button" class="btn btn-danger"
									data-dismiss="modal">Clear</button>
							</div>
					...
					<c:forEach items="${productList}" var="pList">
						<tr>
							<td width="30%"><a data-toggle="modal"
								data-target="#Products"> ${pList.pname}</a></td>
							<td>${pList.pcat}</td>
