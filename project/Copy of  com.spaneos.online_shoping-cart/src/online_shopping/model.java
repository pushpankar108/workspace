...
public class model {
     ...
     public static boolean addCategory(CategoryBean cbean)                       throws SQLException, InstantiationException, IllegalAccessException {
          ...
          ps_ins = con1.prepareStatement("insert into categories(cname,description) values(?,?)");
     ...
     public static boolean addProduct(productBean pbean)
           throws SQLException, InstantiationException, IllegalAccessException {
                Connection con1 = (Connection) JDBCHelper.getConnection();
                 ...
                 ps_ins.setString(2, pbean.getPdes());
                 ps_ins.setInt(3, pbean.getPno());
                 ps_ins.setString(4, pbean.getPcat());
     ...
     public static boolean deleteCategory(String s1)
           throws InstantiationException, IllegalAccessException, SQLException {
                 ...
                 ps_ins = con1.prepareStatement("delete from categories where cname=? ");
                 ps_ins.setString(1, s1);
 
                 ps_ins.execute();
                 ps_ins = con1.prepareStatement("delete from products where category=? ");
                 ps_ins.setString(1, s1);
