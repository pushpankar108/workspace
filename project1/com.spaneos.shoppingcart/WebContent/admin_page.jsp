	...
	<div class="container">
		<div class="row" style="background-color: #3e3436">
			<div class="col-md-2">
				<div class="menu-wrap">
					...
					<div class="navbar-header">
						...
						<a href="login.Ado">&nbsp&nbsp&nbsp Admin Home <span
			...
			<div class="col-md-2  col-md-offset-6">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="/logout.Ado"><span class="glyphicon glyphicon-log-out"></span>
							Logout</a></li>
				</ul>
			</div>
		</div>
		<div class="row">
				...
				<div class="modal-footer">
					<ul class="dropdown-menu" id="cat">
						<c:forEach items="${productList}" var="pList">
							<li><a name="cat" id="cat" data-toggle="modal"
				...
				<div class="modal fade" id="Products" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							Product Description:<textarea class="form-control" rows="5" name="pdes" id="pdes"
									placeholder="Product Description" required></textarea>
								<br>product numbers:<input type="number" class="form-control" name="pno"
								...
								<select name="pcat" id="pcat">
									<c:forEach items="${catList}" var="cList">
										<option><a data-toggle="modal"
												data-target="#Category" name="ctg" value="${cList.cat}">${cList.cat}</a></option>
									</c:forEach>
								</select></br> </br>
								<button type="submit" class="btn btn-primary" id="login">Add
									Products</button>
			...
			<div class="transbox">
				<table width="100%" border="1">
					...
					<c:forEach items="${productList}" var="pList">
						<tr>
							<td width="30%"><a data-toggle="modal"
								data-target="#Products1"> ${pList.pname}</a></td>
							<td>${pList.pcat}</td>
							<td><a data-toggle="modal"
								data-target= "#Products1" ><span
									class="glyphicon glyphicon-pencil"></span></td>
							<td><a href="deleteProduct.Ado?prodval=${pList.pname}"><span
		...
		<div class="footer">
			<div row="" style="background-color: white;">
				<div class="col-md-6 " style="background-color: #3e3436;">

					<h4 style="color: black;" align="center">Shopping center</h4>
				</div>

				<div class="col-md-6" style="background-color: #3e3436;">

					<h4 style="color: black;" align="center">email:
						shopping@center.com</h4>
				</div>
			</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form  action="editProducts.jsp" method="post">
					...
					<div class="modal-body">
						<input type="text" class="form-control" name="pname" id="pname" value="${pList.pname}"
						placeholder="${pList.pname}"	readonly ><br>
						...
						<input type="number" class="form-control" name="price" id="price"
							...
							<input type="text" class="form-control" name="pcat" id="pcat" value="${pList.pcat}" placeholder="${pList.pcat}" readonly ><br>
						

						</select></br> </br>
						<button type="submit" class="btn btn-primary" id="login">Edit product </button>
