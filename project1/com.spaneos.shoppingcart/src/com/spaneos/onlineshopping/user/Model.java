			...
			try {
				...
				if (con == null)
					...
					if (rs.next())
						...
						ps_ins = con.prepareStatement("insert into users(name,email,pass,rpass,mobile,Gender,Address,DOB) values(?,?,?,?,?,?,?,?)");
						...
						ps_ins.setString(4, bean.getRpass());
						ps_ins.setString(5, bean.getMobile());
						ps_ins.setString(6, bean.getOptradio());
						ps_ins.setString(7, bean.getAddress());
						ps_ins.setString(8, bean.getDate());
