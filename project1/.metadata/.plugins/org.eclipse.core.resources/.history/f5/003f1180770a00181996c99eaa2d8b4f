...
<body background="shopping_home.jpg">
	...
	<form action="userhomeInter.jsp" method="post">
        ...
        <form action="registerInter.jsp" method="post">
		<!-- Modal for sign-up-->
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<input type="text" class="form-control" name="uname" id="uname"
							...
							placeholder="Enter your email id" required><br> <input
							type="text" class="form-control" name="psw" id="psw"
							placeholder="Enter password" required><br> <input
							type="text" class="form-control" name="cpsw" id="cpsw"
							placeholder="Confirm password" required><br> <input
							type="text" class="form-control" name="mob" id="mob"
							placeholder="Enter your mobile no." required><br> <input
							type="date" class="form-control" name="dt" id="dt"
							placeholder="mm/dd/yyyy" required><br> <input
							type="radio" name="optradio" checked>Male <input type="radio"
							name="optradio">Female<br> <br>
