 ...
 * Generated at: 2018-02-07 04:49:09 UTC
...
return;
	...
	String ps = request.getParameter("psw");
      ...
      com.spaneos.onlineshopping.user.UserBean log = null;
      log = (com.spaneos.onlineshopping.user.UserBean) _jspx_page_context.getAttribute("log", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (log == null){
        log = new com.spaneos.onlineshopping.user.UserBean();
